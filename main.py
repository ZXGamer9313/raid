...
class OWL():
    ...
    async def start(self):
        ...
        async def askChoice():
            ...
            if choice.__eq__('1'):
                ...
                print('\n                                       ' + Fore.BLUE +
                      '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' + Fore.CYAN +
                      "Thank you for using Imagine Spammer")
                exit()
            else:
                print('\n                                       ' + Fore.BLUE +
                      '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' + Fore.CYAN +
    ...
    async def screen12(self):
        ...
        print(Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' +
              Fore.CYAN + 'Contact: No Contact')
        print(Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' +
              Fore.CYAN + 'Website: No Website')
        print(" ")
        print(
            Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' + Fore.CYAN +
            'Info: Hello User, This is Imagine Spammer, a new spammer for discord. This tool is for spamming discord\'s api and troll servers/users. We want this to be famous and yeah, hope you like it <3.'
        )
        print(" ")
        print(Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' +
    ...
    def exit(self):
        print(Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' +
                  Fore.CYAN + "Thank you for using Imagine Spammer")
        exit()
    ...
    def sendText(self, screen='main'):
        ...
        print((Fore.MAGENTA + '                            Developed by ' +
               Fore.BLUE + 'Imagine' + Fore.MAGENTA + ',' + Fore.BLUE +
               ' Imagine' + Fore.RESET).center(self.center))
        print(' ')
